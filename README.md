...
Hola, soy Jairo Colón un apasionado Software Engineer, desarrollador web autodidacta de inicio y certificado en [Platzi COL](https://www.platzi.com/?target=_blank), también en [Henry Academy ARG](https://www.soyhenry.com/?target=_blank). Mi pasión por el desarrollo software consiste en soñar con ideas y hacerlas realidad con interfaces elegantes. Cuido mucho la experiencia de usuario, la arquitectura y la calidad del código de las cosas que construyo.
...
<code><img height="30" src="https://static-00.iconduck.com/assets.00/woocommerce-plain-wordmark-icon-512x347-xrysp04c.png"></code>
